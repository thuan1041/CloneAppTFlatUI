        ...
        <View style={styles.container}>
            ...
            <View style={styles.bodyWrapper}>
                <View style={styles.inputWrapper}>
                    <TextInput style={styles.inputTxt} placeholder="Nhập cụm từ, câu văn hoặc đoạn văn để dịch" multiline={true} numberOfLines={10}          value={inputText}
                        onChangeText={(text) => setInputText(text)} ></TextInput>
                </View>
                <TouchableOpacity style={styles.inputIcon} onPress={handleClearInput}>
